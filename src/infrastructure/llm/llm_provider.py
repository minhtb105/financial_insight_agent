...
from infrastructure.resilience.circuit_breaker import LLMUnavailableError
...
class LLMProvider:
    ...
    def with_structured_output(
        ...
        class FallbackChain:
            def __init__(self, primary, fallback, rid: str):
        ...
        return FallbackChain(primary, fallback_llm, rid=request_id_var.get() or "unknown")